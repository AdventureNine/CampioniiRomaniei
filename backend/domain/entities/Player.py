class Player:
    def __init__(self, pid: int, name: str):
        ...
        self.__statistics = {
            ...
            "quizzes_solved": 0,
            "quizzes_played": 0,
            "regions_unlocked": ["Transilvania"],
            "cosmetics_unlocked": [self.__cosmetic],
    ...
    def set_regions_unlocked(self, regions_unlocked: list[str]): self.__statistics["regions_unlocked"] = regions_unlocked
    ...
    def set_cosmetics_unlocked(self, cosmetics_unlocked: list[str]): self.__statistics["cosmetics_unlocked"] = cosmetics_unlocked
